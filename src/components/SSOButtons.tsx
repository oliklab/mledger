  ...
  return (
    <div className="mt-6">
      ...
      <div className="mt-4 text-center text-xs text-gray-500">
        ...
        <Link href="/docs/terms" className="text-blue-600 hover:text-blue-800 underline">
          Terms and Conditions
        </Link>
        {' '}and{' '}
        <Link href="/docs/privacy" className="text-blue-600 hover:text-blue-800 underline">
          Privacy Policy
        </Link>
      </div>
    </div>
