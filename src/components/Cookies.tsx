          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500">
                Read our{' '}
                <Link href={`/docs/privacy`} className="text-blue-600 hover:text-blue-700 underline">
                  Privacy Policy
                </Link>{' '}
                and{' '}
                <Link href={`/docs/terms`} className="text-blue-600 hover:text-blue-700 underline">
                  Terms of Service
                </Link>{' '}
